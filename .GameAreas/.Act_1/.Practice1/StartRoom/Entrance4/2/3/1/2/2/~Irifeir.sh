...
echo "Witch: What is this room anyways."
echo "Irifeir: This is, uh, where I rest."
echo "Irifeir: Anyways..."
echo "Irifeir: All that's left is to go see Marhargrah and get you back."
echo "Irifeir: Meet me at the Magus Strand when you are ready."
...
chmod o+rx ~Irifeir_Dialogue.sh
cd Armakur/Miritir
